...
/**
 * Show available courses from the backend table view.
 */
function showCourse() {
...
/**
 * Show registered students from the backend.
 * Falls back silently — registeres.html uses localStorage + sample data.
 */
